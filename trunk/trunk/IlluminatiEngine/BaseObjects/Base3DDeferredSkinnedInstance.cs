...
{
    public class Base3DDeferredSkinnedInstance : GameComponent, IGridRegisterable
    {
        ...
        public Base3DDeferredSkinnedObjectInstancer Instancer;
        ...
        public Base3DDeferredSkinnedInstance(Game game)
            : base(game)
        { }

        public Base3DDeferredSkinnedInstance(Game game, Vector3 position, Vector3 scale, Quaternion rotation, ref Base3DDeferredSkinnedObjectInstancer instancer)
            : base(game)
        {
            Position = position;
            Scale = scale;
