...
namespace PostProcessingFog
{
    ...
    public class Game1 : BaseDeferredRenderGame
    {
        ...
        List<BaseDeferredObject> Boxs = new List<BaseDeferredObject>();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "Space      - Shadows On/Off", new Vector2(0, font.LineSpacing * 5), Color.Gold);
